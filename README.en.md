...
- if redirect preflight times out or hits a request-level error, the current implementation now fails closed instead of silently allowing the provider call
